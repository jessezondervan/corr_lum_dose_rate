...
for line in fil:
    ...
    conglom_corr_ses.append(float(line.split(',')[10]))
    external_gammas.append(float(line.split(',')[11]))
    ext_ses.append(float(line.split(',')[12]))
    Des.append(float(line.split(',')[13]))
    De_ses.append(float(line.split(',')[14]))
